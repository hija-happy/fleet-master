...
import 'package:fleet/route_management/routemanage.dart';
...
import 'package:fleet/drivermangement/driver_info.dart';
            ...
            children: [
                const DrawerHeader(
                  ...
                  ListTile(
                    ...
                    onTap: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context)=> AddRouteScreen()));
                    },
                  ),
                  ListTile(
                    title: const Text("Driver Information"),
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>DriverEntryPage()));
                    },
                  ),
                  ListTile(
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> EnterTripInfoPage()));
                    },
                  ),
                  ListTile(
